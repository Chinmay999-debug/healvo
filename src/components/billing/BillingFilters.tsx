...
export type BillingFilter = "all" | BillStatus;

// "Partially paid" is a real bill status the underlying data/state supports,
// but the current clinic workflow doesn't expose it as a filter — omitted
// here intentionally, not because the status doesn't exist.
const options: { key: BillingFilter; label: string }[] = [
